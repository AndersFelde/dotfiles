...
# exec --no-startup-id xautolock -time 5 -locker "/usr/bin/i3lock-solarized-dark.sh" -killtime 20 -killer "systemctl suspend" -detectsleep 
exec_always --no-startup-id ~/.config/polybar/material/launch.sh
# exec --no-startup-id setxkbmap -option caps:escape
# exec --no-startup-id /usr/bin/dunst
# exec --no-startup-id batsignal -w 20 -c 15 -d 10 -W "Charge maybe?" -C "Should charge" -D "/usr/bin/xbacklight -set 10" -I "/usr/share/icons/Papirus-Dark/16x16/devices/battery.svg"

for_window [class="^.*"] border pixel 3 
gaps inner 20

client.focused           #2979ff #0C3756 #FFFFFF #1F5372
